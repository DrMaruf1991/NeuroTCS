...
class TestPlasmaPtau181Elecsys:
    ...
    def test_pack_version_bumped_to_1_1_1(self, plasma_pack):
        """v1.14.0 bumps plasma_amyloid_consensus from @1.0.0 to @1.1.0.
        v1.18.0 bumps to @1.1.1 after citation completion (filled 14
        pmid_pending entries: 12 with PMID 40729527 from DOI 10.1002/alz.70535
        Palmqvist 2025 AA CPG; 2 with PMID 40357140 from DOI 10.1002/dad2.70116
        Giacomucci 2025 two-cutoffs)."""
        assert plasma_pack.rangepack.pack_version == "1.1.1"
        assert "1.1.1" in plasma_pack.rangepack.rangepack_id
