...
[![Version 1.72.0](https://img.shields.io/badge/version-1.72.0-success.svg)](CHANGELOG.md)
[![Tests 1915](https://img.shields.io/badge/tests-1952%20passed-success.svg)](tests/)
...
# Tests (no cohort data required) -- expect 1952 passed, 26 skipped (v1.72.0; base install)
...
# Full suite with cohort data (set env vars first; expect 1952+cohort tests passed, cohort-version-dependent)
...
The test count is environment-dependent: **1952 passed / 26 skipped** on a base install without cohort env vars (cohort tests + optional-dependency tests skip; current as of v1.72.0). Installing the optional `[radni]` extra engages 4 more tests (1956 passed / 23 skipped). With all four cohort env vars pointing at valid files, the cohort tests additionally execute and pass; the exact pass count is cohort-version-dependent. Both outcomes are correct behavior.
