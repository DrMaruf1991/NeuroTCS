...
[![Tests 1982](https://img.shields.io/badge/tests-1982%20passed-success.svg)](tests/)
...
The test count is environment-dependent: **1982 passed / 23 skipped** on a
standard install without cohort env vars (cohort-data tests skip; current as of
v1.77.1). As of v1.73.0 the R (`pyreadr`) and SPSS (`pyreadstat`) readers ship in
