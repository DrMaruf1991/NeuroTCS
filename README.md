...
[![Tests 2039](https://img.shields.io/badge/tests-2039%20passed-success.svg)](tests/)
...
# Tests (no cohort data required) -- expect 2039 passed, ~24 skipped (v1.83.0)
...
# Full suite with cohort data (set env vars first; expect 2039+cohort tests passed, cohort-version-dependent)
...
The test count is environment-dependent: **2039 passed / 24 skipped** on a
