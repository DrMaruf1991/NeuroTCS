...
[![Tests 2006](https://img.shields.io/badge/tests-2006%20passed-success.svg)](tests/)
...
# Tests (no cohort data required) -- expect 2006 passed, ~24 skipped (v1.80.0)
...
# Full suite with cohort data (set env vars first; expect 2006+cohort tests passed, cohort-version-dependent)
...
The test count is environment-dependent: **2006 passed / 24 skipped** on a
