...
[![Version 1.79.0](https://img.shields.io/badge/version-1.79.0-success.svg)](CHANGELOG.md)
[![Tests 1990](https://img.shields.io/badge/tests-1990%20passed-success.svg)](tests/)
...
# Tests (no cohort data required) -- expect 1990 passed, ~24 skipped (v1.79.0)
...
# Full suite with cohort data (set env vars first; expect 1990+cohort tests passed, cohort-version-dependent)
...
The test count is environment-dependent: **1990 passed / 24 skipped** on a
standard install without cohort env vars (cohort-data tests skip; current as of
v1.79.0). As of v1.73.0 the R (`pyreadr`) and SPSS (`pyreadstat`) readers ship in
