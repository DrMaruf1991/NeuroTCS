...
[![Version 1.82.1](https://img.shields.io/badge/version-1.82.1-success.svg)](CHANGELOG.md)
[![Tests 2020](https://img.shields.io/badge/tests-2020%20passed-success.svg)](tests/)
...
# Tests (no cohort data required) -- expect 2020 passed, ~24 skipped (v1.82.1)
...
# Full suite with cohort data (set env vars first; expect 2020+cohort tests passed, cohort-version-dependent)
...
The test count is environment-dependent: **2020 passed / 24 skipped** on a
