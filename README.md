...
[![Version 1.82.6](https://img.shields.io/badge/version-1.82.6-success.svg)](CHANGELOG.md)
[![Tests 2032](https://img.shields.io/badge/tests-2032%20passed-success.svg)](tests/)
...
# Tests (no cohort data required) -- expect 2032 passed, ~24 skipped (v1.82.6)
...
# Full suite with cohort data (set env vars first; expect 2032+cohort tests passed, cohort-version-dependent)
...
The test count is environment-dependent: **2032 passed / 24 skipped** on a
