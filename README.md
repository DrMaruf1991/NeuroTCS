...
# Tests (no cohort data required) -- expect 1992 passed, ~24 skipped (v1.79.1)
...
# Full suite with cohort data (set env vars first; expect 1992+cohort tests passed, cohort-version-dependent)
