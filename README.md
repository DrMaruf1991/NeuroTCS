...
[![Version 1.82.3](https://img.shields.io/badge/version-1.82.3-success.svg)](CHANGELOG.md)
[![Tests 2024](https://img.shields.io/badge/tests-2024%20passed-success.svg)](tests/)
...
# Tests (no cohort data required) -- expect 2024 passed, ~24 skipped (v1.82.3)
...
# Full suite with cohort data (set env vars first; expect 2024+cohort tests passed, cohort-version-dependent)
...
The test count is environment-dependent: **2024 passed / 24 skipped** on a
