...
[![Version 1.82.0](https://img.shields.io/badge/version-1.82.0-success.svg)](CHANGELOG.md)
[![Tests 2012](https://img.shields.io/badge/tests-2012%20passed-success.svg)](tests/)
...
# Tests (no cohort data required) -- expect 2012 passed, ~24 skipped (v1.82.0)
...
# Full suite with cohort data (set env vars first; expect 2012+cohort tests passed, cohort-version-dependent)
...
The test count is environment-dependent: **2012 passed / 24 skipped** on a
