...
[![Version 1.82.2](https://img.shields.io/badge/version-1.82.2-success.svg)](CHANGELOG.md)
[![Tests 2022](https://img.shields.io/badge/tests-2022%20passed-success.svg)](tests/)
...
# Tests (no cohort data required) -- expect 2022 passed, ~24 skipped (v1.82.2)
...
# Full suite with cohort data (set env vars first; expect 2022+cohort tests passed, cohort-version-dependent)
...
The test count is environment-dependent: **2022 passed / 24 skipped** on a
