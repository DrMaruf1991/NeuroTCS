...
[![Version 1.84.0](https://img.shields.io/badge/version-1.84.0-success.svg)](CHANGELOG.md)
[![Tests 2075](https://img.shields.io/badge/tests-2075%20passed-success.svg)](tests/)
...
# Tests (no cohort data required) -- expect 2075 passed, ~24 skipped (v1.84.0)
...
# Full suite with cohort data (set env vars first; expect 2075+cohort tests passed, cohort-version-dependent)
...
The test count is environment-dependent: **2075 passed / 24 skipped** on a
